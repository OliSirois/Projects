...
for j = 1:TotalLength
  ...
  if ControlDuration == 0
    ...
    ControlDifference = normrnd((ControlParameter - FinalValue(j))*0.5,VariationParameter*0.0005)/ControlDuration;
  ...
  for i = 1:NumDerivatives
    ...
    elseif Duration(i) == 0
      Duration(i) = ceil([0,abs(normrnd((NumDerivatives-i)*VariationParameter,(NumDerivatives-i)))])(2);
